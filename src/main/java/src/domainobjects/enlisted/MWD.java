...
public class MWD {
    ...
    @OneToOne
    @JoinColumn(name = "paired_unit", nullable = true)
    private Unit pairedUnitId;
    ...
    public Unit getPairedUnitId() {
        return pairedUnitId;
    }

    public void setPairedUnitId(Unit pairedUnitId) {
        this.pairedUnitId = pairedUnitId;
    }
}
